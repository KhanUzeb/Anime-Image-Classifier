...
2.  **Optimization**: `src/optuna.py` finds optimal hyperparameters (LR, batch size, etc.).
3.  **Training**:
...
4.  **Evaluation**: `src/evaluate.py` generates detailed per-class performance reports.
